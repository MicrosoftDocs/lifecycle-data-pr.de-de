...
ms.locfileid: "1367562"
---
# <a name="lifecycle-data-export"></a><span data-ttu-id="f6d05-103">Lebenszyklus-Datenexport</span><span class="sxs-lookup"><span data-stu-id="f6d05-103">Lifecycle data export</span></span>

## <a name="export-all-products"></a><span data-ttu-id="f6d05-104">Exportieren aller Produkte</span><span class="sxs-lookup"><span data-stu-id="f6d05-104">Export all products</span></span>
<span data-ttu-id="f6d05-105">Exportieren Sie Lebenszyklusdaten für alle Produkte, indem Sie unten klicken:</span><span class="sxs-lookup"><span data-stu-id="f6d05-105">Export lifecycle data for all products by clicking below:</span></span>

> [!div class="nextstepaction"]
> [<span data-ttu-id="f6d05-106">Exportieren aller Produkte</span><span class="sxs-lookup"><span data-stu-id="f6d05-106">Export All Products</span></span>](https://app-omaha-prod.azurewebsites.net/api/PublishedListings/Export)

## <a name="export-products-by-family-and-group"></a><span data-ttu-id="f6d05-107">Exportieren von Produkten nach Produktfamilie und Gruppe</span><span class="sxs-lookup"><span data-stu-id="f6d05-107">Export products by Family and Group</span></span>
<span data-ttu-id="f6d05-108">Wählen Sie eine Produktfamilie und dann eine Gruppe aus, die exportiert werden soll.</span><span class="sxs-lookup"><span data-stu-id="f6d05-108">Select a Family and then a Group to export.</span></span> <span data-ttu-id="f6d05-109">Hinweis: Der Export beginnt, wenn der Gruppenwert ausgewählt ist.</span><span class="sxs-lookup"><span data-stu-id="f6d05-109">Note: Export will begin when Group value is selected.</span></span> 
...
## <a name="export-products-by-end-of-support-date"></a><span data-ttu-id="f6d05-170">Exportieren von Produkten anhand des Datums des Supportendes</span><span class="sxs-lookup"><span data-stu-id="f6d05-170">Export products by end of support date</span></span>
<span data-ttu-id="f6d05-171">Wählen Sie ein Jahr aus, um zu sehen, welche Produkte in dem Jahr das Ende des Supports erreichen.</span><span class="sxs-lookup"><span data-stu-id="f6d05-171">Select a year to see products reaching the end of support.</span></span> <span data-ttu-id="f6d05-172">Hinweis: Der Export beginnt, wenn der Wert „Jahr“ ausgewählt ist.</span><span class="sxs-lookup"><span data-stu-id="f6d05-172">Note: Export will begin when Year value is selected.</span></span>
